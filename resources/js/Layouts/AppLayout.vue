<template>
    <div class="navigation-bar d-flex justify-content-between bg-white" style="width: 100%; height: 86px; left: 0px; top: 0px;">
        <div class="pos-f-t d-flex align-items-center" style="width: 100px">

<template>
    <nav
        ...
        style="height: 86px; background: white"
    >
        <button
            @click="toggleClass()"
            style="z-index: 2"
        ...
        >
            <svg
                v-bind:class="[isHidden ? 'rotate-effect' : '']"
                xmlns="http://www.w3.org/2000/svg"
                width="30"
                height="30"
                fill="#4C6ED7"
                class="bi bi-list rotate"
                viewBox="0 0 16 16"
            >
                <path
                    fill-rule="evenodd"
        ...
        <div class="dropdown">
            ...
            >
                ...
                <a class="dropdown-item" v-on:click.prevent="logout()" href=""
                    >Logout</a
                >
            </div>
        </div>
    ...
    <div class="row m-0">
        ...
        <div
            v-bind:class="[isHidden ? 'side-bar-0' : 'side-bar']"
            style="z-index: 1"
            class="admin-sidebar"
        >
            <ul>
            ...
            <ul class="list">
                <template v-if="user?.is_admin">
                    ...
                    <li>
                        <a
                            v-bind:class="
                                route().current('admin.exams') ? 'active' : ''
                            "
                    ...
                    <li>
                        <a
                            v-bind:class="
                                ...
                                route().current('academic.diagnostics.create')
                                    ? 'active'
                                    : ''
                            "
                            :href="route('diagnostics', 'academic')"
                            >Academic Diagnostics</a
                        >
                    </li>
                    <li>
                        <a
                            v-bind:class="
                                ...
                                route().current(
                                    'personality.diagnostics.create'
                                )
                                    ? 'active'
                                    : ''
                            "
                            :href="route('diagnostics', 'personality')"
                            >Personality Diagnostics</a
                        >
                    </li>
                </template>
                <template v-if="user?.is_admin || user?.is_tutor">
                    <li>
                        <a
                            v-bind:class="
                                route().current('student.questions')
                                    ? 'active'
                                    : ''
                            "
                ...
                <template v-if="user?.is_admin">
                    <li>
                        <a
                            v-bind:class="
                                route().current('quiz.content') ? 'active' : ''
                            "
                            :href="route('quiz.content')"
                            >Quiz Contents</a
                        >
                    </li>
                    <li>
                        <a
                            v-bind:class="
                                route().current('diagnostic.content')
                                    ? 'active'
                                    : ''
                            "
                            :href="route('diagnostic.content')"
                            >Diagnostic Quiz Contents</a
                        >
                    </li>
                </template>
                <template v-if="user?.is_admin">
                    <li>
                        <a
                            v-bind:class="
                                route().current('math.formula.for.quiz')
                                    ? 'active'
                                    : ''
                            "
                            :href="route('math.formula.for.quiz')"
                            >Math Formula</a
                        >
                    </li>
                </template>
        ...
        <div
            v-bind:class="[isHidden ? 'main-content' : 'main-content-1']"

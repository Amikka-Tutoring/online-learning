                    ...
                    <form action="">
                        <div class="form-item">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input type="text" id="id" name="id" v-model="user.id" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-item">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input type="text" id="name" name="name" v-model="user.name" disabled>
                        ...
                        <div class="form-item">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input type="text" id="current_score" name="current_score" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-item">

    ...
    <app-layout>
            ...
            <div v-if="form.currentstep != 1 && form.currentstep !=8">
                <div class="row align-items-center">
                    ...
                    <div class="col-1 blue-text">Skip</div>
                </div>
            </div>
        ...
        <div>
            <form @submit="submit" class="form">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="input-cards">
                                <img class="w-100" :src="'https://images.theconversation.com/files/195198/original/file-20171117-7588-1rai1rs.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=926&fit=clip'" >
                                <div class="row">
                                    <div class="col-9">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input id="check-box" type="checkbox" name="course" v-model="form.course">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-cards">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input id="check-box-0" type="checkbox" name="course" v-model="form.course">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-cards">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input id="check-box-1" type="checkbox" name="course" v-model="form.course">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-cards">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input id="check-box-2" type="checkbox" name="course" v-model="form.course">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <button v-if="form.currentstep!=7 && form.currentstep!=1" @click.prevent="next()" class="blue-button">Next</button>
                <button v-if="form.currentstep==7" type="submit" class="blue-button">Submit</button>
            </form>
        </div>
    </app-layout>
</template>

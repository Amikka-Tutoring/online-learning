            ...
            <div class="academic-content pl-5" style="margin-top: 90px">
                <transition name="list">
                    <p class="question-box text-left" v-if="academic">
                        <div class="row">
                            <div class="col-11">
                                Answer these short quizzes in order to help us build you a personalized program based on your current strengths and weaknesses.
                            </div>
                ...
                <transition name="list">
                    <p v-if="calendar" class="question-box text-left">
                        <div class="row">
                            ...
                            <div class="col-1 d-flex align-items-center" data-aos="fade-up" data-aos-delay="50" data-aos-once="true">
            ...
            <div class="notes-content pl-5" style="margin-top: 90px">
                <transition name="list">
                    <p v-if="notes" class="question-box text-left">
                        <div class="row">
                            <div class="col-11">
                                This is where all of your voice and written notes will be saved for all of the courses that you are taking.
                            </div>
                            <div class="col-1 d-flex align-items-center">
